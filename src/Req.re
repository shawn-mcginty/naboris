...
let fromReqd = (reqd, sessionConfig, staticCacheControl, staticLastModified) => {
  ...
  let defaultReq = {requestDescriptor: reqd, session: None, sidKey, maxAge, secret, staticCacheControl, staticLastModified};
  defaultReq;
};
